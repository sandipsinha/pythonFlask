...
class AAWSBase( object ):
    ...
    frate     = Column( MEDIUMINT( unsigned=True ) )
    ...
    trate     = Column( MEDIUMINT( unsigned=True ) )
...
class AccountState( Base ):
    ...
    tRate     = Column( 'trate', MEDIUMINT( unsigned=True ) )
    fRate     = Column( 'frate', MEDIUMINT( unsigned=True ) )
